...
typedef void (^HYPRBooleanResultCallback)(BOOL isOfferReady);
 ...
 *
 *  @param checkCallback    A block that will simply return the checkInventory callback when the checkInventory: method's
 *         callback is invoked.
 */
